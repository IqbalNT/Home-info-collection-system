								...
								<table id="table_id" class="display table table-responsive table-border table-responsive table-striped" >
									...
									<tbody class="tbody_color_voucher" >
									  ...
									  <tr>
										...
										<td><a class="btn btn-success button_darkblue" href="voucher.php?voucherID=<?php echo $voucher_id; ?>&name=<?php echo $name;?>&cell=<?php echo $cell;?>&name=<?php echo $name;?>&oid=<?php echo $id;?>&month=<?php echo $month;?>&year=<?php echo $year;?>" target="_blank"> View </a></td>
									  </tr>
											<?php }}?>						  
									</tbody>					
								</table>
