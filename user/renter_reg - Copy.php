...
<?php include 'include/navbar.php'; ?>	
		<form id="regForm" action="code/add_renter_reg.php" enctype="multipart/form-data" method="POST" role="form" >
		  <h1>Renter Registration Form </h1>
		  <!-- One "tab" for each step in the form: -->
		  <div class="tab">Personal Details:
			<div class="row">
				<div class="col-md-6">
					<p><input placeholder="Renter Name" oninput="this.className = ''" name="owName"></p>
				...
				<div class="col-md-6">
					<p><input placeholder="House / Holding Number" oninput="this.className = ''" name="housenumber"></p>
					...
					<p><input placeholder="Police Station" oninput="this.className = ''" name="policestation"></p>
					<p><input type="text" placeholder="Cell Number"   name="cell"></p>
					<p><input type="text" placeholder="District"   name="dist"></p>						
					<p>
			...
			<table class="table table-bordered" id="dynamic_field"> 
					<tr>  
						...
						<div class="form-group">
						 ...
						 <td>
						 <div class="form-group">
						  <label for="comment">NID Number</label>
						  <input type="input" name="relnid[]" class="form-control" rows="1" id="comment"></textarea>
						 </div>
						 </td>						 
		  ...
		  <div class="tab">Flat Information
			<p><input placeholder="Floor Number" oninput="this.className = ''" name="floorNum"></p>
			<p><input placeholder="Block" oninput="this.className = ''" name="block"></p>
			<p><input placeholder="Room Number" oninput="this.className = ''" name="roomNumber"></p>
			<p><input placeholder="Entrance Date" type="text" oninput="this.className = ''" onfocus="(this.type='date')" name="entranceDate"></p>
		  </div>		  
